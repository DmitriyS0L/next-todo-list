...
export class Auto1760903647176 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TYPE "public"."todos_status_enum" AS ENUM('Pending', 'In Progress', 'Completed', 'Done')`);
        await queryRunner.query(`CREATE TYPE "public"."todos_type_enum" AS ENUM('Task', 'Story', 'Epic', 'Bug', 'Spike')`);
        await queryRunner.query(`CREATE TYPE "public"."todos_priority_enum" AS ENUM('LOW', 'MEDIUM', 'HIGH', 'CRITICAL')`);
